      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Ready to contribute to forward-thinking engineering teams. Let's discuss how I can help bring your ideas to life.
          </p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                {contactMethods.map((method, index) => (
                  <Card key={index} className={`group hover:shadow-elegant transition-smooth shadow-card border-0 bg-card/50 backdrop-blur-sm ${method.primary ? 'ring-2 ring-primary/20' : ''}`}>
                    <CardContent className="p-6">
                      <div className="flex items-start gap-4">
                        <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${method.primary ? 'bg-gradient-primary text-white' : 'bg-muted'} group-hover:scale-110 transition-transform`}>
                        ...
                        <div className="flex-1">
                          ...
                          {method.note && (
                            <p className="text-sm text-muted-foreground mt-1">{method.note}</p>
                          )}
                        </div>
                      </div>
                    </CardContent>
          ...
          <div className="space-y-8">
            <Card className="shadow-elegant border-0 bg-gradient-primary text-white">
              <CardContent className="p-8">
                <h3 className="text-2xl font-semibold mb-4">Currently Seeking</h3>
                <p className="opacity-90 mb-6 leading-relaxed">
                  I'm actively looking for exciting opportunities to contribute to innovative projects 
                  and collaborate with passionate teams worldwide.
                </p>
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  <div className="border-l-2 border-primary pl-4">
                    <h4 className="font-semibold text-foreground">B.Sc. in Accounting</h4>
                    <p className="text-sm text-muted-foreground">Ajayi Crowther University, Nigeria</p>
                    <p className="text-xs text-muted-foreground mt-1">Analytical & problem-solving foundations</p>
                  </div>
                  <div className="border-l-2 border-accent pl-4">
                    <h4 className="font-semibold text-foreground">Meta Front-End Developer</h4>
                    <p className="text-sm text-muted-foreground">Coursera Specialization</p>
                    <p className="text-xs text-muted-foreground mt-1">React, Advanced Patterns, State Management</p>
                  </div>
                  <div className="border-l-2 border-primary-glow pl-4">
                    <h4 className="font-semibold text-foreground">Front-End Bootcamp</h4>
                    <p className="text-sm text-muted-foreground">Udemy Certification</p>
                    <p className="text-xs text-muted-foreground mt-1">HTML, CSS, JavaScript, UI/UX Best Practices</p>
                  </div>
                </div>
              </CardContent>
            </Card>
